...
public class Main {	
	...
	Section bio1 = new Section("bio1");
	Section bio2 = new Section("bio2");
	...
	private void readDataFromDb() {
		...
		TranscriptEntry[] entries =
			{
					new TranscriptEntry(new Student("bob"),new Section("bio1")), 
					new TranscriptEntry(new Student("bob"),new Section("math")), 
					new TranscriptEntry(new Student("tim"),new Section("bio1")),				
					new TranscriptEntry(new Student("tim"),new Section("math")), 
					new TranscriptEntry(new Student("allen"),new Section("math")), 
					new TranscriptEntry(new Student("allen"),new Section("bio2"))
			};
