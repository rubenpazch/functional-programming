...
//		m.printProduct(list);
		...
		List<Boolean> listBoolean = Arrays.asList(false,false,false,false,false);
		m.printDifferenceBoolean(listBoolean);
	...
	public void printDifferenceBoolean(List<Boolean> list) {
		boolean diff1 = list.stream().reduce(false, (x,y)->x||y);
		System.out.println("diff1= "+diff1);
