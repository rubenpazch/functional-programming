package democode.lesson9.lecture.iterate;
...
public class Examples {
	...
	public static void main(String[] args) {
		...
		Stream<Integer> odd =
				Stream.iterate(1, n -> n+1).filter(n->n%2!=0);

		odd.limit(8).skip(4).collect(Collectors.toList()).forEach(System.out::println);	
		//System.out.println( odd.limit(10).skip(4).collect(Collectors.toList()));
